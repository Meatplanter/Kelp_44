...
func _input(event):
	if canMove == true:
		if event.is_action_pressed("LS_move_right"):
			targPos[0] += 32
			tween = create_tween()
		...
		elif event.is_action_pressed("LS_move_left"):
			targPos[0] -= 32
			tween = create_tween()
			tween.set_parallel(true)
			tween.tween_property(self,"position",Vector2(targPos[0],targPos[1]),moveTime).set_trans(Tween.TRANS_BACK)
		...
		elif event.is_action_pressed("LS_move_up"):
			targPos[1] -= 32
			tween = create_tween()
			tween.set_parallel(true)
			tween.tween_property(self,"position",Vector2(targPos[0],targPos[1]),moveTime).set_trans(Tween.TRANS_BACK)
		...
		elif event.is_action_pressed("LS_move_down"):
			targPos[1] += 32
			tween = create_tween()
			tween.set_parallel(true)
			tween.tween_property(self,"position",Vector2(targPos[0],targPos[1]),moveTime).set_trans(Tween.TRANS_BACK)
		...
		elif event.is_action_pressed("LS_move_rightup"):
			targPos[0] += 32
			targPos[1] -= 32
			tween = create_tween()
			tween.set_parallel(true)
		...
		elif event.is_action_pressed("LS_move_rightdown"):
			targPos[0] += 32
			targPos[1] += 32
			tween = create_tween()
			tween.set_parallel(true)
		...
		elif event.is_action_pressed("LS_move_leftup"):
			targPos[0] -= 32
			targPos[1] -= 32
			tween = create_tween()
			tween.set_parallel(true)
		...
		elif event.is_action_pressed("LS_move_leftdown"):
			targPos[0] -= 32
			targPos[1] += 32
			tween = create_tween()
			tween.set_parallel(true)
